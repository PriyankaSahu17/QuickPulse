...
const Dashboard1 = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useGetProfile(`${BASE_URL}/volunteers/profile/me`);
  useEffect(() => {
    if (volunteerData) {
        ...
        {!loading && !error && (
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px] ">
            ...
            <div className="lg:col-span-2">
              {volunteerData.isApproved === "pending" && (
                <div
                  id="alert-4"
              ...
              <div className="mt-8">
                  ...
                  <div>
                    <div className="flex gap-5 items-center mb-10">
                      <figure className="max-w-[200px] max-h-[200px]">
                        <img src={volunteerData.photo} alt="" className="w-full" />
                      </figure>
                      <div>
                ...
                {tab === "settings" && <Profile volunteerData={volunteerData} />}
                {tab === "appointments" && (
                  <Appointments appointments={volunteerData.appointments} />
                )}
              </div>
            </div>
          </div>
